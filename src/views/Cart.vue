        ...
        <el-container>
            ...
            <el-main>
                <el-card class="box-card">
                    ...
                    <el-table :data="cart" border style="width: 59%;top:-50px">
                        <el-table-column fixed prop="uid" label="用户信息" width="100">
                        </el-table-column>
                        <el-table-column prop="mid" label="药材信息" width="120">
                        </el-table-column>

                        <el-table-column prop="snumber" label="数量" width="260">
                            <template slot-scope="scope">
                                <el-input-number v-model="scope.row.snumber" @change="handleChange(scope.row)" :min="1"
                        ...
                        <el-table-column label="操作" width="190">
                            <template slot-scope="scope">
                                <el-button size="medium" type="success" @click="buy(scope.row)">购买</el-button>
...
export default {
    ...
    created() {
        ...
        var _this = this
        axios.get(`http://localhost:8081/shop/getShopTypeCO?id=${_this.user.uid}&type=0`).then(function (res) {
    ...
    methods: {
        ...
        buy(shop){
            ...
            axios.put("http://localhost:8081/shop/editShop", shop).then(function (res2) {
                ...
                _this.$message.success("购买成功请到订单里面查看！！！");
                location.reload();
                 });
        },

        async del(shop) {
            const confirmResult = await this.$confirm('操作会删除购物车该条信息,是否继续', '提示', {
